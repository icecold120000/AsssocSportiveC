...
namespace BLL
{
    public class GestionAdherant
    {
        ...
        public static int NombreTotalAdherant()
        {
            return AdherantDAO.CountTotalAdherant();
        }

        public static int NombreTotalAdherantGarçon()
        {
            return AdherantDAO.CountAdherantParGarçon();
        }

        public static int NombreTotalAdherantFille()
        {
            return AdherantDAO.CountAdherantParFille();
        }

        public static List<AdherantBO> FiltreAdherant(string textSaisie)
        {
            return AdherantDAO.FiltreAdherant(textSaisie);
        }
    }
}
